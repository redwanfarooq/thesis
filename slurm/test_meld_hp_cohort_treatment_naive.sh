...
"$BASEDIR/scripts/test_meld_hp.py" \
    ...
    --output "$BASEDIR/results/tables/cite_seq/cohort_treatment_naive/test_meld_hp.tsv" \
    --log "$BASEDIR/results/tables/cite_seq/cohort_treatment_naive/test_meld_hp.log" \
    --k-lower 5 \
    --k-upper 51 \
    --k-step 5 \
    --b-lower 10 \
